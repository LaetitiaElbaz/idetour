...
|poiName|TEXT|NOT NULL|POI's name|
|description|TEXT|NOT NULL|POI's description|
|address|VARCHAR(255)|NOT NULL|POI's adress|
|latitude|DECIMAL(10,6)|NULL, UNSIGNED|POI's latitude|
|longitude|DECIMAL(10,6)|NULL, UNSIGNED|POI's longitude|
|slug|VARCHAR(255)|NULL|POI's slug|
...
|categoryName|VARCHAR(64)|NOT NULL|Category's name|
...
|tagName|VARCHAR(64)|NOT NULL|Tag's name|
...
|reviewName|VARCHAR(64)|NOT NULL|Review's name|
...
|roleName|VARCHAR(100)|NULL|Role of the contact|
...
|firstName|string(255)|NOT NULL|Contact's name|
|lastName|string(255)|NOT NULL|Contact's name|
...
|ageGroup|TEXT|NOT NULL|Audience's group|
...
|day|VARCHAR (8) |NOT NULL|Opening days|
...
|cityCode|VARCHAR(6)|NOT NULL|City's zip code|
|cityName|VARCHAR(255)|NOT NULL|City's name|
...
|departmentCode|VARCHAR(6)|NOT NULL|Department's code|
|departmentName|VARCHAR(255)|NOT NULL|Department's name|
...
|areaCode|VARCHAR(6)|NOT NULL|Area's code|
|areaName|VARCHAR(255)|NOT NULL|Area's name|
...
|countryCode|VARCHAR(6)|NOT NULL|Country's code|
|countryName|VARCHAR(255)|NOT NULL|Country's name|
